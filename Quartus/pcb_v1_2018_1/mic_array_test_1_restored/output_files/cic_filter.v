...
// Retrieval info: <MEGACORE title="CIC"  version="13.0"  build="232"  iptb_version="1.3.0 Build 232"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.CICModel"  active_core="cic_filter_cic" >
...
// Retrieval info:      <PRIVATE name = "Number of Stages" value="4"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Rate Change Factor" value="14"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Differential Delay" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Input Bit Width" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Output Bit Width" value="16"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Hogenauer Pruning" value="0"  type="BOOLEAN"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="cic_filter.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="cic_filter_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
